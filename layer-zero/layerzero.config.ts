...
const roostockContract: OmniPointHardhat = {
    eid: EndpointId.ROOTSTOCK_V2_TESTNET,
    contractName: 'ZkLending',
}

const sepoliaContract: OmniPointHardhat = {
    eid: EndpointId.SEPOLIA_V2_TESTNET,
    contractName: 'ZkScoreSender',
}
...
const pathways: TwoWayConfig[] = [
    [
        ...
        roostockContract, // Chain B contract
...
export default async function () {
    ...
    return {
        contracts: [{ contract: sepoliaContract }, { contract: roostockContract }],
        connections,
    }
}
